...
def fake_play():
    ...
    p1 = torch.tensor(
        np.array(
            [0.0000,  0.0000,  0.0000, 0.0,  0.0000,  0.5, 0.5,  0.0,  0.0])).type(torch.FloatTensor)
    ...
    p2 = torch.tensor(
        np.array(
            [0.0000,  0.0000,  0.0000, 0.0,  0.0000,  0.0, 0.0,  0.0,  1.0])).type(torch.FloatTensor)
